...
impl VertexInput {
    pub const VERTEX_ATTRIBUTES: [wgpu::VertexAttribute; 5] = [
        ...
        wgpu::VertexAttribute {
            ...
            offset: std::mem::offset_of!(VertexInput, alpha) as u64,
            shader_location: 2,
        },
        wgpu::VertexAttribute {
            format: wgpu::VertexFormat::Float32,
            offset: std::mem::offset_of!(VertexInput, _pad) as u64,
            shader_location: 3,
        },
        wgpu::VertexAttribute {
...
pub fn vs_main_entry(in_step_mode: wgpu::VertexStepMode) -> VertexEntry<1> {
    VertexEntry {
