...
public class DumpHandleChecks extends GhidraScript {
  ...
  public void run() throws Exception {
    ...
    out=new java.io.PrintWriter(new java.io.FileWriter("handlechecks_decomp.txt"));
    dump(0x884d0L,"handle_ready_884d0");
    dump(0x896a0L,"set_flag_896a0");
