...
public class DumpLoadInit extends GhidraScript {
  ...
  public void run() throws Exception {
    ...
    out=new java.io.PrintWriter(new java.io.FileWriter("loadinit_decomp.txt"));
    dump(0x3540860L,"dir_load_init_3540860");
